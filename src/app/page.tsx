      ...
      lessons: [
        {
          ...
          content: [
            ...
            '⚡ Arrays allow RANDOM ACCESS - you can access any element directly using its index.',
            '📏 Arrays have a FIXED SIZE in most languages (not in JavaScript).'
          ],
          codeExample: `// Declaring an array
...
arr[4] = 50  // Last element`
        },
        {
          ...
          content: [
            ...
            '➕ INSERT at end: O(1) - Just add at the end',
            '➕ INSERT at middle: O(n) - Need to shift elements',
            '🗑️ DELETE: O(n) - Need to shift elements to fill gap',
            '🔍 SEARCH: O(n) - Linear search, O(log n) - Binary search (sorted)'
          ],
          codeExample: `// Insert at index
    ...
    arr[index] = value;
        ...
        },
        {
          ...
          content: [
            ...
            '❌ NOT ideal when frequent insertions/deletions in middle',
            '❌ NOT ideal when size changes frequently'
          ]
        }
      ],
      quiz: [
        {
          ...
          correctAnswer: 0,
          explanation: 'Arrays provide direct/random access using index, so it takes constant time O(1).'
        },
        {
          id: 2,
          ...
          correctAnswer: 1,
          explanation: 'In most programming languages, array indices start from 0.'
        },
        {
          id: 3,
          question: 'What happens when you insert an element in the middle of an array?',
          options: ['Nothing', 'Elements shift right', 'Elements shift left', 'Array doubles in size'],
          correctAnswer: 1,
          explanation: 'When inserting in the middle, all elements after the insertion point must shift right to make room.'
        },
        {
          id: 4,
          ...
          correctAnswer: 1,
          explanation: 'Inserting at the end (append) is O(1) because no shifting is needed.'
        },
        {
          id: 5,
          question: 'Arrays store elements in:',
          options: ['Random memory locations', 'Contiguous memory locations', 'Linked nodes', 'Binary tree'],
          correctAnswer: 1,
          explanation: 'Arrays store elements in contiguous (adjacent) memory locations, which enables fast random access.'
        }
      ]
    },
    {
      ...
      lessons: [
        {
          ...
          content: [
            ...
            '🎯 The first node is called HEAD, the last points to NULL.',
...
head->next = NULL;`
        },
        {
          ...
          content: [
            ...
            '🗑️ DELETE: O(n) to find, O(1) to remove',
            '✅ No shifting needed unlike arrays!'
          ],
          codeExample: `// Insert at head
void insertAtHead(int value) {
    ...
    head = newNode;
        ...
        },
        {
          ...
          content: [
            '1️⃣ SINGLY Linked List - Each node points to next only',
            '2️⃣ DOUBLY Linked List - Nodes point to both next and previous',
            '3️⃣ CIRCULAR Linked List - Last node points back to head',
            '💡 Choose based on your traversal needs!'
          ]
        }
      ],
      quiz: [
        {
          ...
          options: ['Only data', 'Data and pointer to next', 'Data and pointer to previous', 'Only pointer'],
          correctAnswer: 1,
        ...
        },
        {
          ...
          options: ['O(n)', 'O(1)', 'O(log n)', 'O(n²)'],
          correctAnswer: 1,
          explanation: 'Inserting at head is O(1) because we just update the head pointer to the new node.'
        },
        {
          id: 3,
        ...
        },
        {
          ...
          options: ['O(1)', 'O(n)', 'O(log n)', 'O(n²)'],
          correctAnswer: 1,
          explanation: 'Unlike arrays, we must traverse from head to reach the nth element, making it O(n).'
        },
        {
          id: 5,
          question: 'Which type of linked list allows traversal in both directions?',
          options: ['Singly linked list', 'Doubly linked list', 'Circular linked list', 'Simple linked list'],
          correctAnswer: 1,
          explanation: 'Doubly linked list has pointers to both next and previous nodes, allowing bidirectional traversal.'
        }
      ]
    },
    {
      ...
      lessons: [
        {
          ...
          content: [
            ...
            '⬆️ Elements are added and removed from the TOP only.',
            '🍽️ Think of a stack of plates - you take from the top!',
...
s.pop();     // Removes 30`
        },
        {
          ...
          content: [
            '⬆️ PUSH: O(1) - Add element to top',
            '⬇️ POP: O(1) - Remove element from top',
            '👁️ PEEK/TOP: O(1) - View top element without removing',
            '❓ isEmpty: O(1) - Check if stack is empty',
            '📏 SIZE: O(1) - Get number of elements'
          ],
          codeExample: `// Implementation using array
class Stack {
    int top = -1;
    int arr[100];
    ...
    bool isEmpty() { return top == -1; }
        ...
        },
        {
          ...
          content: [
            ...
            '↩️ Undo/Redo operations in editors',
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['O(n)', 'O(1)', 'O(log n)', 'O(n²)'],
          correctAnswer: 1,
          explanation: 'Push is O(1) because we always add at the top, no traversal needed.'
        },
        {
          id: 4,
          question: 'What does peek() operation do?',
          options: ['Remove top element', 'Add element', 'View top without removing', 'Clear the stack'],
          correctAnswer: 2,
          explanation: 'Peek returns the top element without removing it from the stack.'
        },
        {
          id: 5,
          question: 'Which of these uses a stack?',
          options: ['Print queue', 'Function call management', 'Customer service line', 'Playlist'],
          correctAnswer: 1,
          explanation: 'Function calls use a call stack - when a function is called, it\'s pushed; when it returns, it\'s popped.'
        }
      ]
    },
    {
      ...
      lessons: [
        {
          ...
          content: [
            ...
            '➡️ Elements are added at REAR and removed from FRONT.',
            '🎫 Think of a ticket line - first person in line is served first!',
            '💡 Used in: scheduling, BFS, print queues, buffers'
          ],
          codeExample: `// Queue operations
queue<int> q;

q.push(10);   // Add to rear (enqueue)
q.push(20);
q.push(30);

q.front();    // Returns 10 (front element)
q.pop();      // Removes 10 (dequeue)`
        },
        {
          id: 2,
          ...
          content: [
            ...
            '👁️ FRONT: O(1) - View front element',
            '👁️ REAR: O(1) - View rear element',
...
class Queue {
    ...
    bool isEmpty() { return front > rear; }
        ...
        },
        {
          ...
          content: [
            '1️⃣ SIMPLE Queue - Basic FIFO',
            '2️⃣ CIRCULAR Queue - Rear connects back to front',
            '3️⃣ PRIORITY Queue - Elements have priorities',
            '4️⃣ DEQUE (Double-ended) - Insert/delete from both ends',
            '💡 Circular queue solves the unused space problem!'
          ]
        }
      ],
      quiz: [
        {
          ...
          options: ['LIFO', 'FIFO', 'Random access', 'LILO'],
          correctAnswer: 1,
        ...
        },
        {
          ...
          options: ['O(n)', 'O(1)', 'O(log n)', 'O(n²)'],
          correctAnswer: 1,
          explanation: 'Dequeue is O(1) because we always remove from the front, no traversal needed.'
        },
        {
          id: 4,
          ...
          correctAnswer: 3,
          explanation: 'Dequeue removes the front element from the queue.'
        },
        {
          id: 5,
          question: 'Which of these is a real-world example of a queue?',
          options: ['Stack of books', 'Undo button', 'People waiting in line', 'Recursive function'],
          correctAnswer: 2,
          explanation: 'People waiting in line is a perfect example - first person in line is served first (FIFO).'
        }
      ]
    }
  ];
  ...
  if (!isAuthenticated) {
    return (
      <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: 10,
                background: authScreen === 'login' ? 'linear-gradient(135deg, #667eea, #764ba2)' : 'transparent',
                color: 'white',
                fontSize: 14,
                fontWeight: 'bold',
                cursor: 'pointer',
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: 10,
                background: authScreen === 'register' ? 'linear-gradient(135deg, #667eea, #764ba2)' : 'transparent',
                color: 'white',
                fontSize: 14,
                fontWeight: 'bold',
                cursor: 'pointer',
            ...
            <div>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  border: 'none',
                  background: authLoading ? '#555' : 'linear-gradient(135deg, #667eea, #764ba2)',
                  color: 'white',
        ...
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12, marginTop: 30 }}>
          © 2024 EduAR - Data Structure Learning
        </p>
  ...
  // ==================== EDUCAR DASHBOARD (MAIN SCREEN AFTER LOGIN) ====================
  return (
    <div style={{
      width: '100vw',
      minHeight: '100vh',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 20, color: 'white' }}>🎓 EduAR</h1>
        </div>
      ...
      <div style={{ padding: 20 }}>
        ...
        {/* LESSON SCREEN */}
        {eduARScreen === 'lesson' && getCurrentSubject() && (
        ...
        {/* QUIZ SCREEN */}
        {eduARScreen === 'quiz' && getCurrentSubject() && (
          <div style={{ maxWidth: 700, margin: '0 auto' }}>
            <button
              onClick={() => setEduARScreen('dashboard')}
              style={{
        ...
        {/* RESULTS SCREEN */}
        {eduARScreen === 'results' && getCurrentSubject() && (
  ...
  const handleNextQuestion = () => {
    const subject = eduARSubjects.find(s => s.id === selectedSubject);
    if (!subject) return;

    if (currentQuizIndex < subject.quiz.length - 1) {
      setCurrentQuizIndex(currentQuizIndex + 1);
      setSelectedAnswer(null);
      setShowExplanation(false);
    } else {
      const correctAnswers = quizAnswers.filter((answer, index) => 
        answer === subject.quiz[index]?.correctAnswer
      ).length + (selectedAnswer === subject.quiz[currentQuizIndex]?.correctAnswer ? 1 : 0);
      
      const score = Math.round((correctAnswers / subject.quiz.length) * 100);
      
      setUserProgress(prev => ({
        ...prev,
        quizScores: { ...prev.quizScores, [selectedSubject!]: score },
        totalScore: Math.round(
          Object.values({ ...prev.quizScores, [selectedSubject!]: score }).reduce((a, b) => a + b, 0) / 
          Object.keys({ ...prev.quizScores, [selectedSubject!]: score }).length
        )
      }));
      
      setEduARScreen('results');
    }
  };
  ...
  const handleNextLesson = () => {
    ...
    if (currentLessonIndex < subject.lessons.length - 1) {
      ...
      setUserProgress(prev => ({
        ...prev,
        lessonCompleted: {
          ...prev.lessonCompleted,
          [selectedSubject!]: subject.lessons.map(l => l.id)
        }
      }));
      setEduARScreen('dashboard');
    }
  ...
  const getCurrentSubject = () => eduARSubjects.find(s => s.id === selectedSubject);
